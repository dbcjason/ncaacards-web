  ...
  return (
    <form action="/api/admin/organizations" method="post" className="grid gap-4 md:grid-cols-2">
      <label className="space-y-2">
        ...
        <input className="site-input" name="organizationName" required />
      </label>
      ...
      <div className="space-y-2 md:col-span-2">
        ...
        <div className="flex flex-col gap-3 md:flex-row">
          ...
          />
          <button
            className="site-button-secondary md:w-auto"
            type="button"
            onClick={() => setAccessCode(generateSixDigitCode())}
          >
      ...
      <label className="flex items-center gap-3 text-sm text-zinc-100 md:col-span-2">
        ...
        Send the access code by email as soon as the organization is created
      </label>

      <div className="md:col-span-2">
        <button className="site-button" type="submit">Create Organization</button>
      </div>
    </form>
  );
}
